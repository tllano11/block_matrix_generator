...
void launch_jacobi(double* A, double* gpu_A, double* gpu_b,
  ...
  for (int i = 0; i < total_iters; ++i) {
    ...
    assert(cudaSuccess == cudaMemcpy(gpu_A, A_ptr, rows_gpu*cols_A*double_size, cudaMemcpyHostToDevice));
